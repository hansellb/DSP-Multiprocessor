 ...
 */
#define IMG_SIZE_40x40x3		0x12C0	// Image size used during performance measurements ( 32 * 32 * 3 ) = 3072 = 0xC00. We need to add three more bytes corresponding to the dimensions (width and height) and maximum color levels
...
#define IMG_SIZE_20x20x1		0x190	// Image size used during performance measurements ( 16 * 16 * 1 ) =  256 = 0x100. We need to add three more bytes corresponding to the dimensions (width and height) and maximum color levels
...
#define IMG_1_ADDR				SHARED_ONCHIP_BASE	// 0x102000
#define IMG_2_ADDR				(IMG_1_ADDR + IMG_SIZE_32x32x3 + 0x8)	// 0x102c08. The +0x8 aligns data in memory to 64 bits and leaves 5 bytes free between images
...
#define IMG_1_32x32x3_ADDR		SHARED_ONCHIP_BASE	// 0x102000
#define IMG_2_32x32x3_ADDR		(IMG_1_32x32x3_ADDR + IMG_SIZE_32x32x3 + 0x8)	// 0x102c08. The +0x8 aligns data in memory to 64 bits and leaves 5 bytes free between images
#define IMG_1_32x32x1_ADDR		(IMG_2_32x32x3_ADDR + IMG_SIZE_32x32x3 + 0x8)	// 0x103810.
#define IMG_1_16x16x1_ADDR		(IMG_2_32x32x3_ADDR + IMG_SIZE_32x32x3 + 0x8)	// 0x103810
#define IMG_2_16x16x1_ADDR		(IMG_1_16x16x1_ADDR + IMG_SIZE_16x16x1 + 0x8)	// 0x103918
#define IMG_3_16x16x1_ADDR		(IMG_2_16x16x1_ADDR + IMG_SIZE_16x16x1 + 0x8)	// 0x103a20
#define IMG_4_16x16x1_ADDR		(IMG_3_16x16x1_ADDR + IMG_SIZE_16x16x1 + 0x8)	// 0x103b28

#define IMG_1_40x40x3_ADDR		SHARED_ONCHIP_BASE
#define IMG_1_20x20x1_ADDR		(IMG_1_40x40x3_ADDR + IMG_SIZE_40x40x3 + 0x8)
#define IMG_2_20x20x1_ADDR		(IMG_1_20x20x1_ADDR + IMG_SIZE_20x20x1 + 0x8)
#define IMG_3_20x20x1_ADDR		(IMG_2_20x20x1_ADDR + IMG_SIZE_20x20x1 + 0x8)
#define IMG_4_20x20x1_ADDR		(IMG_3_20x20x1_ADDR + IMG_SIZE_20x20x1 + 0x8)

#define IMG_DSP_DONE_MSG		0x69696969
#if PERFORMANCE
...
uBYTE ascii_symbols [] = {32,46,59,42,115,116,73,40,106,117,86,119,98,82,103,64};